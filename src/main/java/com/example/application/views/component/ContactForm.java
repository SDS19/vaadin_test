...
public class ContactForm extends FormLayout {//a responsive layout that shows form fields in 1 or 2 columns depending in view port

    /******************** data binding: Contact <=> ContactForm ********************/
    ...
    public ContactForm(List<Company> companies, List<Status> statuses) {
        ...
        add(firstName, lastName, email, company, status, getBtnLayout());
    }

    /****************************** button layout ******************************/

    private HorizontalLayout getBtnLayout() {
